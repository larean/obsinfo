...
class instrument_components:
    """ Everything in a instrument-components information file"""
    def __init__(self,filename,referring_file=None,debug=False):
        """ Read instrument-components information file"""
        ...
        self.instrument_blocks=temp['instrument-components']['instrument_blocks']
        
    def __repr__(self) :
        return "<instrument-components: {}>".format(self.filename)    
